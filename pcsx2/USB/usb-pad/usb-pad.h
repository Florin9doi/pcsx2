...
#define N_JOYSTICK TEXT("joystick")
	...
	public:
		...
		static std::vector<std::string> SubTypes()
		{
			...
			ret.push_back("Driving Force");
			ret.push_back("Driving Force Pro");
			ret.push_back("Driving Force Pro (rev11.02)");
			ret.push_back("GT Force");
			return ret;
		}
	};
	...
	public:
		...
		{
			std::vector<std::string> ret;
			ret.push_back("RealPlay Racing");
			ret.push_back("RealPlay Sphere");
			ret.push_back("RealPlay Golf");
			ret.push_back("RealPlay Pool");
			return ret;
		}
		static void Initialize();
	};
...
#define DESC_CONFIG_WORD(a) (a & 0xFF), ((a >> 8) & 0xFF)
	...
	static const uint8_t gametrak_ps2_hid_report_descriptor[] = {
		0x05, 0x01,       // Usage Page (Generic Desktop Ctrls)
		0x09, 0x04,       // Usage (Joystick)
		0xA1, 0x01,       // Collection (Application)
	...
	// The others are force-brutted to be accepted by games - they may be inaccurate.
